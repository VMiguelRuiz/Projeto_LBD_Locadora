...
public class ControleCliente {
	...
	public void adicionaCliente(String cliente_nome, String clienteCPF, String cliente_telefone,
	...
	public void alteraCliente(String clienteID, String cliente_nome, String clienteCPF, String cliente_telefone,
			String cliente_endereco) {
	...
	public void listaCliente(String nome) {
		ClienteDAO cliente_dao = new ClienteDAO();
		List<Cliente> clientes = cliente_dao.listaCliente();
		for (Cliente cliente : clientes) {
			System.out.println("ID: " + cliente.getIdCliente());
